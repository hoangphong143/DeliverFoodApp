...
import com.example.minhnguyen.appfoodserver.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Quản lí thực đơn");
    ...
    private void showDialog() {
        ...
        alertDialog.setTitle("Thêm danh mục món ăn");
        alertDialog.setMessage("Nhập tên danh mục");
        ...
        alertDialog.setPositiveButton("Đồng ý", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (newCategory != null){
                  ...
                  Snackbar.make(drawer,"Danh mục món mới "+newCategory.getName()+" đã được thêm",Snackbar.LENGTH_SHORT)
                          .show();
                }
    ...
    private void loadMenu() {
        ...
        adapter.notifyDataSetChanged(); //Refresh data changed
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            Intent orders = new Intent(Home.this,SendMessage.class);
            startActivity(orders);
        }
